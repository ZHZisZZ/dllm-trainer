...
class ModelArguments(editflow_sft.ModelArguments):
    model_name_or_path: str = "models/EditFlow-Dream-7B-Base/dclm-baseline-1.0[train:5000000,test:100000]"
...
class TrainingArguments(editflow_sft.TrainingArguments):
    output_dir: str = "models/EditFlow-Dream-7B-Instruct-SFT/tulu-3-sft-mixture[train:10000,test:1000]"
