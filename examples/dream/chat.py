...
python -u examples/dream/chat.py --model_name_or_path "YOUR_MODEL_PATH" --chat True --visualize True

# Raw single-turn generation
python -u examples/dream/chat.py --model_name_or_path "YOUR_MODEL_PATH" --chat False --visualize False
"""
import sys
