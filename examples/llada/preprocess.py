"""
python examples/llada/preprocess.py --num_proc 64 --dataset_args "HuggingFaceTB/smoltalk" --output_dir "data/sft/llada/smoltalk"
python examples/llada/preprocess.py --num_proc 64 --dataset_args "allenai/tulu-3-sft-mixture" --output_dir "data/sft/llada/tulu-3-sft-mixture"
"""
