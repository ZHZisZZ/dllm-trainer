...
def get_tokenizer(
    ...
    assert tokenizer.eos_token or tokenizer.pad_token
    ...
    if issubclass(model_cls, LLaDAModelLM):
        ...
        tokenizer.eot_token_id = tokenizer.convert_tokens_to_ids("<|eot_id|>")
...
""".lstrip()
        ...
        tokenizer.eot_token_id = tokenizer.convert_tokens_to_ids("<|role_end|>")
    elif issubclass(model_cls, DreamModel):
        tokenizer.eot_token = "<|im_end|>"
        tokenizer.eot_token_id = tokenizer.convert_tokens_to_ids("<|im_end|>")
